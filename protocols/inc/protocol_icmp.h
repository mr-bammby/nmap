...
/* Error codes for ICMP protocol operations */
...
/**
 * Process an ICMP response packet and update scan results.
 *
 * @param transport Pointer to the transport layer data (ICMP).
